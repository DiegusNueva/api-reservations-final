package com.edteam.apireservationsfinal.exception;

import com.edteam.apireservationsfinal.dto.ErrorDTO;
...
public class APIExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> duplicateResource(CustomException e, WebRequest request) {
