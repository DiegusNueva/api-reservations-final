...
import com.edteam.apireservationsfinal.util.ReservationUtil;
...
class ReservationUtilTest {
    ...
    void getReservation_should_return_the_information() {
        ...
        // When
        Reservation result = getReservation(1L, "MIA", "EZE");
    ...
    void getReservation_should_return_the_information_with_mocks() {
        try (MockedStatic<ReservationUtil> utilities = Mockito.mockStatic(ReservationUtil.class)) {
            ...
            // Then
            assertAll(() -> assertNotNull(result), () -> assertEquals(2L, result.getId()), // Se espera que devuelva el
                                                                                           // id 2L
    ...
    static Reservation getReservation(Long id, String origin, String destination) {
        ...
        reservation.setId(id); // <- Este valor es importante
