...
class ReservationRepositoryTest {
    ...
    private static final Logger LOGGER = Logger.getLogger(ReservationRepositoryTest.class.getName());
    ...
    void getReservations_should_return_the_information() {
        // GIVEN
        ReservationRepository repository = new ReservationRepository();
        Reservation expectedReservation = repository.save(getReservation(null, "AEP", "MIA"));
        // WHEN
        List<Reservation> result = repository.getReservations();
        // THEN
        assertAll(() -> assertNotNull(result), () -> assertThat(result, hasSize(2)),
                () -> assertThat(result, hasItem(expectedReservation)), // Usar el objeto guardado
